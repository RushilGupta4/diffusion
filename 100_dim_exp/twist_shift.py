...
def train(
    ...
    for epoch in range(start_epoch + 1, num_epochs + 1):
        ...
        if epoch == num_epochs or epoch % 25 == 0:
            ...
            # take random number of samples from the distribution (i.e. take num_samples random samples from dist)
...
def main():
    ...
    if BOUNDED:
        ckpt = "model_shift_bounded/epoch_{step}.pth"
        png_file = "model_shift_bounded/comparison.png"
        losses_file = "model_shift_bounded/losses.png"
    else:
        ckpt = "model_shift/epoch_{step}.pth"
        png_file = "model_shift/comparison.png"
        losses_file = "model_shift/losses.png"
    ...
    if BOUNDED:
        ...
        dist = create_multivariate_normal(num_points=num_points, dtype=dtype, dim=dim)
